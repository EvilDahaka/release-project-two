...
('Wireless Mouse', 25.99, '2.4GHz, Optical, 1600 DPI', NULL, 'mouse'),
('Smartphone X', 799.00, '128GB, OLED Display, Dual Camera', NULL, 'phone'),
('Mechanical Keyboard', 89.99, 'Cherry MX Red switches, RGB Lighting', NULL, 'keyboard'),
('Noise Cancelling Headphones', 199.00, 'Bluetooth, 20h battery life, ANC', NULL, 'audio'),
('Ultra HD Monitor', 349.00, '27", 4K Resolution, IPS Panel', NULL, 'monitor'),
('Smartphone Charger', 15.00, 'Fast Charging, USB-C', NULL, 'accessoires'),
('Graphics Tablet', 129.99, '10"x6", 8192 Pressure Levels, USB', NULL, 'tablets'),
('Smartwatch', 179.00, 'Heart Rate Monitor, GPS, 5ATM Water Resistance', NULL, 'gadgets'),
...
('Gaming Headset', 119.00, '7.1 Surround Sound, Noise Cancelling', NULL, 'audio'),
...
('Touchscreen Monitor', 249.00, '24", Full HD, Touchscreen', NULL, 'monitor'),
('Smart LED Light Bulb', 29.99, 'RGB, WiFi enabled, Voice Control', NULL, 'accessoires'),
('Game Console', 399.00, '4K HDR, Blu-ray player', NULL, 'consoles'),
('Gaming Mouse', 69.99, 'RGB Lighting, Adjustable DPI', NULL, 'mouse'),
